...
describe("JsonPointerRepository Integration Tests", () => {
    ...
    describe("putDocument / getDocument", () => {
        ...
        it("overwrites a large document and correctly deletes more than 25 stale pointers", async () => {
            ...
            const replacement = { kept: true };
            await repository.putDocument("large-overwrite-1", replacement as TestDocument);
            expect(await repository.getDocument("large-overwrite-1")).toEqual(replacement);
        });
